...
import '../controllers/getTrap_controller.dart';

class GetTrapView extends GetView<GetTrapController> {
   GetTrapView({Key? key}) : super(key: key);
...
//           children: [
//             CachedNetworkImage(
//               imageUrl: image, // Replace with your image asset
//               fit: BoxFit.cover,
